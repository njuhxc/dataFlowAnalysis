...
/**
 * Convenience functions for constructing and navigating Esprima ASTs.
 */
...
define(function(require, exports) {
  ...
  exports.getAttribute = function(nd, name, deflt) {
    nd.attr = nd.attr || {};
      return name in nd.attr ? nd.attr[name] : (nd.attr[name] = deflt);
  };
  ...
  exports.isFunctionNode = function(nd) {
    return nd && (nd.type === 'FunctionDeclaration' ||
